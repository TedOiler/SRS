...
y_uni_normal         = matrix(NA, R, n_1) 
y_uni_gamma          = matrix(NA, R, n_1) 
y_multi_normal_gamma_0 = matrix(NA, R, n_1/2)
y_multi_normal_gamma_1 = matrix(NA, R, n_1/2) 
y_multi_normal_gamma = matrix(NA, R, n_1) 
# MCMC
for(r in 1:R){
  ...
  y_multi_normal_gamma_0[r, ] = rnorm (n_1/2,mean=hyp_norm_mean,sd=hyp_norm_sd)
  y_multi_normal_gamma_1[r, ] = rgamma(n_1/2,shape=hyp_gamma_shape,rate=hyp_gamma_rate)
}
