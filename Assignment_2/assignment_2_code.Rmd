...
MCMC_uni_nor = colMeans(y_uni_normal) 
MCMC_kde_uni_norm = density(MCMC_uni_nor, n=n_1)
...
MCMC_uni_norm_error = splinefun(MCMC_kde_uni_norm$x, (MCMC_kde_uni_norm$y - dnorm(MCMC_kde_uni_norm$x))^2)
ISE_uni_norm = integrate(MCMC_uni_norm_error, lower = min(MCMC_uni_nor), upper = max(MCMC_uni_nor))
ISE_uni_norm
```
