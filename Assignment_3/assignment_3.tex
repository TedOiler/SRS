...
{\indent \sf $\text{Bret Zeldow}^1, \text{Vincent Lo Re III}^2, \text{Jason Roy}^3$
\\
\ti{ 
\qquad \qquad\qquad \qquad  1. Department of Health Care Policy, Harvard Medical School
\qquad \qquad\qquad \qquad  2. Department of Medicine, Perelman School of Medicine, University of Pennsylvania
\qquad \qquad\qquad \qquad  3. Department of Biostatistics and Epidemiology, Rutgers School of Public Health}
%\vspace{0.2em}\\
%
}
{\vspace{3em}\\
